...
class Client(BaseClient):
    ...
    def continue_update_rollback(self, StackName: str, RoleARN: str = None, ResourcesToSkip: List = None,
                                 ClientRequestToken: str = None) -> Dict:
        """
    ...
    def create_change_set(self, StackName: str, ChangeSetName: str, TemplateBody: str = None, TemplateURL: str = None,
                          UsePreviousTemplate: bool = None, Parameters: List = None, Capabilities: List = None,
                          ResourceTypes: List = None, RoleARN: str = None, RollbackConfiguration: Dict = None,
                          NotificationARNs: List = None, Tags: List = None, ClientToken: str = None,
                          Description: str = None, ChangeSetType: str = None) -> Dict:
        """
        ...
        :param Capabilities:
          ...
          * ``CAPABILITY_AUTO_EXPAND``   Some template contain macros. Macros perform custom processing on templates; this can include simple actions like find-and-replace operations, all the way to extensive transformations of entire templates. Because of this, users typically create a change set from the processed template, so that they can review the changes resulting from the macros before actually creating the stack. If your stack template contains one or more macros, and you choose to create a stack directly from the processed template, without first reviewing the resulting changes in a change set, you must acknowledge this capability. This includes the `AWS\:\:Include <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/create-reusable-transform-function-snippets-and-add-to-your-template-with-aws-include-transform.html>`__ and `AWS\:\:Serverless <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/transform-aws-serverless.html>`__ transforms, which are macros hosted by AWS CloudFormation.
          .. note::
           ...
           For more information on macros, see `Using AWS CloudFormation Macros to Perform Custom Processing on Templates <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html>`__ .
          - *(string) --*
    ...
    def create_stack(self, StackName: str, TemplateBody: str = None, TemplateURL: str = None, Parameters: List = None,
                     DisableRollback: bool = None, RollbackConfiguration: Dict = None, TimeoutInMinutes: int = None,
                     NotificationARNs: List = None, Capabilities: List = None, ResourceTypes: List = None,
                     RoleARN: str = None, OnFailure: str = None, StackPolicyBody: str = None,
                     StackPolicyURL: str = None, Tags: List = None, ClientRequestToken: str = None,
                     EnableTerminationProtection: bool = None) -> Dict:
        """
        ...
        :param Capabilities:
          ...
          * ``CAPABILITY_AUTO_EXPAND``   Some template contain macros. Macros perform custom processing on templates; this can include simple actions like find-and-replace operations, all the way to extensive transformations of entire templates. Because of this, users typically create a change set from the processed template, so that they can review the changes resulting from the macros before actually creating the stack. If your stack template contains one or more macros, and you choose to create a stack directly from the processed template, without first reviewing the resulting changes in a change set, you must acknowledge this capability. This includes the `AWS\:\:Include <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/create-reusable-transform-function-snippets-and-add-to-your-template-with-aws-include-transform.html>`__ and `AWS\:\:Serverless <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/transform-aws-serverless.html>`__ transforms, which are macros hosted by AWS CloudFormation. Change sets do not currently support nested stacks. If you want to create a stack from a stack template that contains macros *and* nested stacks, you must create the stack directly from the template using this capability.
          .. warning::
           ...
           For more information, see `Using AWS CloudFormation Macros to Perform Custom Processing on Templates <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html>`__ .
          - *(string) --*
        :type ResourceTypes: list
        :param ResourceTypes:
    ...
    def create_stack_instances(self, StackSetName: str, Accounts: List, Regions: List, ParameterOverrides: List = None,
                               OperationPreferences: Dict = None, OperationId: str = None) -> Dict:
        """
    ...
    def create_stack_set(self, StackSetName: str, Description: str = None, TemplateBody: str = None,
                         TemplateURL: str = None, Parameters: List = None, Capabilities: List = None, Tags: List = None,
                         AdministrationRoleARN: str = None, ExecutionRoleName: str = None,
                         ClientRequestToken: str = None) -> Dict:
        """
        Creates a stack set.
        ...
        **Response Structure**
        ...
        :param Capabilities:
          ...
          * ``CAPABILITY_AUTO_EXPAND``   Some templates contain macros. If your stack template contains one or more macros, and you choose to create a stack directly from the processed template, without first reviewing the resulting changes in a change set, you must acknowledge this capability. For more information, see `Using AWS CloudFormation Macros to Perform Custom Processing on Templates <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html>`__ .
          .. note::
             Stack sets do not currently support macros in stack templates. (This includes the `AWS\:\:Include <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/create-reusable-transform-function-snippets-and-add-to-your-template-with-aws-include-transform.html>`__ and `AWS\:\:Serverless <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/transform-aws-serverless.html>`__ transforms, which are macros hosted by AWS CloudFormation.) Even if you specify this capability, if you include a macro in your template the stack set operation will fail.
          - *(string) --*
        :type Tags: list
        :param Tags:
    ...
    def delete_stack(self, StackName: str, RetainResources: List = None, RoleARN: str = None,
    ...
    def delete_stack_instances(self, StackSetName: str, Accounts: List, Regions: List, RetainStacks: bool,
                               OperationPreferences: Dict = None, OperationId: str = None) -> Dict:
        """
    ...
    def describe_stack_resource_drifts(self, StackName: str, StackResourceDriftStatusFilters: List = None,
                                       NextToken: str = None, MaxResults: int = None) -> Dict:
        """
    ...
    def describe_stack_resources(self, StackName: str = None, LogicalResourceId: str = None,
                                 PhysicalResourceId: str = None) -> Dict:
        """
    ...
    def estimate_template_cost(self, TemplateBody: str = None, TemplateURL: str = None,
    ...
    def get_template_summary(self, TemplateBody: str = None, TemplateURL: str = None, StackName: str = None,
                             StackSetName: str = None) -> Dict:
        """
    ...
    def list_stack_instances(self, StackSetName: str, NextToken: str = None, MaxResults: int = None,
                             StackInstanceAccount: str = None, StackInstanceRegion: str = None) -> Dict:
        """
    ...
    def list_stack_set_operation_results(self, StackSetName: str, OperationId: str, NextToken: str = None,
                                         MaxResults: int = None) -> Dict:
        """
    ...
    def update_stack(self, StackName: str, TemplateBody: str = None, TemplateURL: str = None,
                     UsePreviousTemplate: bool = None, StackPolicyDuringUpdateBody: str = None,
                     StackPolicyDuringUpdateURL: str = None, Parameters: List = None, Capabilities: List = None,
                     ResourceTypes: List = None, RoleARN: str = None, RollbackConfiguration: Dict = None,
                     StackPolicyBody: str = None, StackPolicyURL: str = None, NotificationARNs: List = None,
                     Tags: List = None, ClientRequestToken: str = None) -> Dict:
        """
    ...
    def update_stack_instances(self, StackSetName: str, Accounts: List, Regions: List, ParameterOverrides: List = None,
                               OperationPreferences: Dict = None, OperationId: str = None) -> Dict:
        """
    ...
    def update_stack_set(self, StackSetName: str, Description: str = None, TemplateBody: str = None,
                         TemplateURL: str = None, UsePreviousTemplate: bool = None, Parameters: List = None,
                         Capabilities: List = None, Tags: List = None, OperationPreferences: Dict = None,
                         AdministrationRoleARN: str = None, ExecutionRoleName: str = None, OperationId: str = None,
                         Accounts: List = None, Regions: List = None) -> Dict:
        """
    ...
    def update_termination_protection(self, EnableTerminationProtection: bool, StackName: str) -> Dict:
        """
        Updates termination protection for the specified stack. If a user attempts to delete a stack with termination protection enabled, the operation fails and the stack remains unchanged. For more information, see `Protecting a Stack From Being Deleted <AWSCloudFormation/latest/UserGuide/using-cfn-protect-stacks.html>`__ in the *AWS CloudFormation User Guide* .
