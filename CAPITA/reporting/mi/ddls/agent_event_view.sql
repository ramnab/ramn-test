CREATE OR REPLACE VIEW agent_event_view_local AS
SELECT
  "rowdate"
, "clientname"
, "awsaccountid"
...
, "date_format"("from_iso8601_timestamp"("json_extract_scalar"("currentagentsnapshot", '$.agentstatus.starttimestamp')) AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "currentagentsnapshotagentstatusstarttimestamp"
...
, "eventid"
, "date_format"("eventtimestamp" AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "eventtimestamp"
, "eventtype"
, "instancearn"
...
, "date_format"("from_iso8601_timestamp"("json_extract_scalar"("previousagentsnapshot", '$.agentstatus.starttimestamp')) AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "previousagentsnapshotagentstatusstarttimestamp"
...
FROM
  ccm_connect_reporting_test.agent_events
