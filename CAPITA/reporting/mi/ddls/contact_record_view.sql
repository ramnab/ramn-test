...
, "date_format"("from_iso8601_timestamp"("json_extract_scalar"("agent", '$.aftercontactworkendtimestamp')) AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "aftercontactworkendtimestamp"
, "date_format"("from_iso8601_timestamp"("json_extract_scalar"("agent", '$.aftercontactworkstarttimestamp')) AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "aftercontactworkstarttimestamp"
, CAST("json_extract_scalar"("agent", '$.agentinteractionduration') AS bigint) "agentinteractionduration"
, "date_format"("from_iso8601_timestamp"("json_extract_scalar"("agent", '$.connectedtoagenttimestamp')) AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "connectedtoagenttimestamp"
...
, "initialcontactid"
, "initiationmethod"
, "date_format"("initiationtimestamp" AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "initiationtimestamp"
, "date_format"("lastupdatetimestamp" AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "lastupdatetimestamp"
, "nextcontactid"
, "previouscontactid"
, "date_format"("from_iso8601_timestamp"("json_extract_scalar"("queue", '$.dequeuetimestamp')) AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "queuedequeuetimestamp"
, CAST("json_extract_scalar"("queue", '$.duration') AS bigint) "queueduration"
, "date_format"("from_iso8601_timestamp"("json_extract_scalar"("queue", '$.enqueuetimestamp')) AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "queueenqueuetimestamp"
...
, "date_format"("transfercompletedtimestamp" AT TIME ZONE 'Europe/London', '%Y-%m-%d %H:%i:%S') "transfercompletedtimestamp"
, "transferredtoendpoint"
FROM
  ccm_connect_reporting_test.contact_record
